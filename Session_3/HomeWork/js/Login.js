...
class Login{
    ...
    inputUser = new InputCommon("material-icons icon","inputLogin","text","Username");
    inputPw = new InputCommon("material-icons icon","inputLogin","password","Password");
    ...
    constructor(){
        ...
        let twitter = new LinkCommon("#","twitter","fa fa-twitter fa-fw","Twitter");
